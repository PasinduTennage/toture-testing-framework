...
nohup ./${dummy_path} --name 4 --ui --config dummy/configuration/local-proxy/4.cfg > logs/dummy/4.log &
nohup ./${dummy_path} --name 5 --ui --config dummy/configuration/local-proxy/5.cfg > logs/dummy/5.log &
...
./${torture_path} --name 16 --config torture/configuration/local-config.cfg  --debugOn --debugLevel 2 --attacker lProxy > logs/torture/16.log
