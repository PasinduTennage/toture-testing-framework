...
nohup ./${dummy_path} --name 1 --ui --config dummy/configuration/local-proxy/1.cfg --debugOn --debugLevel 12 --interArrivalTime ${interArrivalTime} > logs/dummy/1.log &
nohup ./${dummy_path} --name 2 --ui --config dummy/configuration/local-proxy/2.cfg --debugOn --debugLevel 12 --interArrivalTime ${interArrivalTime} > logs/dummy/2.log &
nohup ./${dummy_path} --name 3 --ui --config dummy/configuration/local-proxy/3.cfg --debugOn --debugLevel 12 --interArrivalTime ${interArrivalTime} > logs/dummy/3.log &
nohup ./${dummy_path} --name 4 --ui --config dummy/configuration/local-proxy/4.cfg --debugOn --debugLevel 12 --interArrivalTime ${interArrivalTime} > logs/dummy/4.log &
nohup ./${dummy_path} --name 5 --ui --config dummy/configuration/local-proxy/5.cfg --debugOn --debugLevel 12 --interArrivalTime ${interArrivalTime} > logs/dummy/5.log &
