...
python3 /home/pasindu/Documents/toture-testing-consensus/simulator.py --server_name replica --threshold 3 --test_time 60 --view_time 200 --benchmark_type  none --epoch_time 5
